...
import com.vng.materialdialogs.internal.main.DialogTitleLayout
...
import com.vng.materialdialogs.utils.MDUtil.updatePadding
import com.vng.materialdialogs.utils.inflate
...
class DialogContentLayout(
  ...
  fun addProgressView(
    ...
    customView?.findViewById<RtlTextView>(R.id.md_text_title)?.text = title
    if(textColor != null){
      customView?.findViewById<RtlTextView>(R.id.md_text_title)?.setTextColor(textColor)
    }
    addView(customView)
    return customView!!
  }

...
import com.vng.materialdialogs.utils.MDUtil.resolveColors
...
internal fun MaterialDialog.resolveColor(
  ...
  fallback: (() -> Int)? = null
): Int = resolveColor(contextThemeWrapper, res, attr, fallback)

@CheckResult
internal fun MaterialDialog.resolveColors(
  attrs: IntArray,
  fallback: ((forAttr: Int) -> Int)? = null
) = resolveColors(contextThemeWrapper, attrs, fallback)

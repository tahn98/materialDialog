...
package com.vng.materialdialogs.list
...
import com.vng.materialdialogs.internal.list.PlainListDialogAdapter
import com.vng.materialdialogs.utils.MDUtil.assertOneSet
import com.vng.materialdialogs.utils.MDUtil.getStringArray
import com.vng.materialdialogs.utils.MDUtil.ifNotZero
import com.vng.materialdialogs.utils.MDUtil.resolveDrawable
...
fun MaterialDialog.getItemSelector(): Drawable? {
  val drawable = resolveDrawable(context = windowContext, attr = R.attr.md_item_selector)

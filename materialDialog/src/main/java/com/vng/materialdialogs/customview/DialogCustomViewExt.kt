 ...
 */
package com.vng.materialdialogs.customview
...
import com.vng.materialdialogs.utils.MDUtil.waitForWidth
...
fun MaterialDialog.progressView(
    @LayoutRes viewRes: Int? = null,
    view: View? = null,
    title: String,
    textColor: Int? = null,
    ...
    this.view.contentLayout
        .addProgressView(
            res = R.layout.md_dialog_progress,
            view = view,
            title = title,
            textColor = textColor
        )
